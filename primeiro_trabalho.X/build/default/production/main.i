...
unsigned int pacotes = 0;

unsigned int rm_pacote = 0;

unsigned int ps_c = 0;

unsigned char char_value[5];
# 10 "main.c" 2
...
void __attribute__((picinterrupt(("")))) myIsr() {
    ...
    if (INTCONbits.RBIE && INTCONbits.RBIF) {
        ...
        if (PORTBbits.RB4 == 1 && PORTBbits.RB5 == 1) {
            ...
            if (PORTBbits.RB4 == 1 && rm_pacote == 0) {
                option = 'A';


                if (PORTBbits.RB6 == 1 && PORTBbits.RB5 == 0 && PORTCbits.RC1 == 0) {
                    PORTCbits.RC2 = 1;
                }


            } else if (PORTCbits.RC2 == 1 && PORTBbits.RB5 == 1) {
                PORTCbits.RC0 = 1;
                PORTCbits.RC2 = 0;
                rm_pacote = 1;
                option = 'R';
            ...
            if (PORTBbits.RB5 == 1 && rm_pacote == 0) {
                option = 'B';


                if (PORTBbits.RB6 == 1 && PORTBbits.RB4 == 0 && PORTCbits.RC2 == 0) {
                    PORTCbits.RC1 = 1;
                }


            } else if (PORTCbits.RC1 == 1 && PORTBbits.RB4 == 1 && rm_pacote == 0) {
                PORTCbits.RC0 = 1;
                PORTCbits.RC1 = 0;
                rm_pacote = 1;
                option = 'R';
        ...
        } else if (PORTBbits.RB4 == 0 && PORTBbits.RB5 == 0 && PORTBbits.RB6 == 0) {
            PORTCbits.RC2 = 0;
            PORTCbits.RC1 = 0;
            PORTCbits.RC0 = 0;
            option = 'P';
        ...
        } else if (PORTBbits.RB4 == 0 && PORTBbits.RB5 == 0 && PORTBbits.RB6 == 1 && rm_pacote == 1) {
            PORTCbits.RC0 = 0;
            rm_pacote = 0;
            ps_c = 0;
            option = 'P';
