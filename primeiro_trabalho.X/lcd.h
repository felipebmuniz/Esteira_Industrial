...
// LCD 16x2 or 16x4
#define LCD16_LIN1      0x80 // Endere?o da primeira linha na RAM do LCD
#define LCD16_LIN2      0xC0 // Endere?o da segunda linha na RAM do LCD
#define LCD16_LIN3      0x90 // Endere?o da terceira linha na RAM do LCD
#define LCD16_LIN4      0xD0 // Endere?o da quarta linha na RAM do LCD
// LCD 20x2
#define LCD20_LIN1      0x80 // Endere?o da primeira linha na RAM do LCD
#define LCD20_LIN2      0xC0 // Endere?o da segunda linha na RAM do LCD
#define LCD20_LIN3      0x94 // Endere?o da terceira linha na RAM do LCD
#define LCD20_LIN4      0xD4 // Endere?o da quarta linha na RAM do LCD
